package com.cyf.bubblepopupwindow.view;
...
import com.cyf.bubblepopupwindow.R;
...
public class BubbleRelativeLayout extends RelativeLayout {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        //获取layout中设置的属性
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.BubbleRelativeLayout);
            try {
                mPadding = a.getDimensionPixelSize(R.styleable.BubbleRelativeLayout_padding, PADDING);
                mBgColor = a.getInt(R.styleable.BubbleRelativeLayout_bgColor, BG_COLOR);
                mShadowColor = a.getInt(R.styleable.BubbleRelativeLayout_shadowColor, SHADOW_COLOR);
                mTriangleHalfBase = a.getDimensionPixelSize(R.styleable.BubbleRelativeLayout_halfBaseOfLeg, TRIANGLE_HALF_BASE);
                mStrokeWidth = a.getFloat(R.styleable.BubbleRelativeLayout_strokeWidth, STROKE_WIDTH);
                mCornerRadius = a.getFloat(R.styleable.BubbleRelativeLayout_cornerRadius, CORNER_RADIUS);
            } finally {
                if (a != null) {
                    a.recycle();
                }
